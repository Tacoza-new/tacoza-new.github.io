        ...
        <div className="py-12 md:py-28 md:pb-20">
          ...
          <div className="max-w-sm mx-auto grid gap-12 md:grid-cols-3 md:-mx-9 md:gap-0 items-start md:max-w-none">
            ...
            >
                ...
                <svg width="56" height="56" xmlns="http://www.w3.org/2000/svg">
                  <defs>
                    <linearGradient x1="50%" y1="100%" x2="50%" y2="0%" id="a">
                      ...
                      <stop stopColor="rose" offset="100%" />
                    </linearGradient>
                  </defs>
              ...
              <h4 className="text-xl font-bold mb-1">QR-Based Ordering</h4>
              <p className="text-slate-500">
              Streamlined digital ordering that reduces service time and improves order accuracy. Customers order directly from their table, minimizing wait times and staff workload.              </p>
            </div>
            ...
            >
              ...
              <h4 className="text-xl font-bold mb-1">Analytics Dashboard</h4>
              <p className="text-slate-500">
              Comprehensive business intelligence platform providing real-time insights into sales performance, customer behavior, and operational efficiency metrics.</p>
            </div>
            ...
            >
              ...
              <h4 className="text-xl font-bold mb-1">Order Management</h4>
              <p className="text-slate-500">
              End-to-end order tracking and fulfillment system with real-time status updates, payment processing, and delivery coordination for optimal customer experience.               </p>
            </div>
          </div>
        </div>
      </div>
