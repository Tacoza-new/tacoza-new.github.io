        ...
        <div className="py-12 md:py-20">
          <div className="sm:flex sm:flex-col lg:flex-row justify-between items-center">
            ...
            <div className="mb-6 lg:mr-16 lg:mb-0 text-center lg:text-left">
              <p className="text-xl text-rose-500 font-[550] mb-3">
                Ready to Optimize Operations?
              </p>
              <h2 className="h2 text-slate-100">
                Drive Growth Through Strategic Implementation
              </h2>
            </div>
            ...
            <div className="shrink-0">
              <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center md:justify-start space-y-4 sm:space-y-0 sm:space-x-4 mb-12 md:mb-0">
                <div>
                  <Link
                    className="btn-sm w-full inline-flex items-center text-rose-50 bg-rose-500 hover:bg-rose-600 group shadow-sm"
                    href="/apply"
                  >
